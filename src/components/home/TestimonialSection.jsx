...
export function TestimonialSection({ testimonial }) {
  ...
  return (
    <section className="relative w-full bg-[#F1F0EB] text-[#111210] py-24 border-b border-[rgba(17,18,16,0.12)]">
      <div className="w-full max-w-4xl mx-auto px-6 sm:px-10 text-center flex flex-col items-center">
        ...
        <div className="flex flex-col items-center gap-1 font-sans">
          ...
          {testimonial.projeto && (
            <span className="font-mono text-[10px] uppercase tracking-widest text-[#4056F4] mt-1">
